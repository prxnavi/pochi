export default function Footer() {
  return (
    <footer className="border-t-2 border-ink/10 mt-auto">
      <div className="max-w-5xl mx-auto px-5 py-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm font-semibold text-ink-soft">
        <a
          ...
          className="hover:text-box-pink-deep transition-colors"
        >
          send feedback
        </a>
